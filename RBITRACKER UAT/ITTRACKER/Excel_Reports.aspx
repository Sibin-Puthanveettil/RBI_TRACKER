<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="Excel_Reports.aspx.cs" Inherits="RBIDATATRACK.Excel_Reports" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <link href="StyleAutoComplete.css" rel="stylesheet" />
<script src="AutoCompleteJS.js"></script>
    <script src="js/excel_reports.js" + "new Date().getTime()"></script>
...
function frmExit() {
    window.location = "../Index/Index.aspx";
      ...
      //      window.open('AshSalesReport.aspx?frdt=' + fromdt + '&todt=' + todt + '&mnuId=' + mnuId + '&unid=' + unid + '&stid=' + stid + '', '_self');
      //  }
       ...
       <div class="card-body">
            <div class="container"> <br /> <br />
                 <div class="row justify-content-center">
                     <h4 style="color: #080254; left:50px;">RBI AUTOMATION STATUS REPORTS</h4>
                 <br /> <br />
            </div>
           </div><br /><br />
            ...
            <div class="row justify-content-center align-items-center" ><br />
                       <div class="row col-md-6 p-1">
                         ...
                         <select class="form-control select2  col-md-10 " id="ddldoc" style="width: 50% " >
                         <option value="-1">Select Fraud id</option>
           ...
           <div class="row justify-content-center align-items-center" >  
                ...
                <div class="col-md-2 col-sm-2 col-xs-4"  id="btnvisb1">
                        <a href="#" class="btn btn-sm animated-button thar-one btn-success" style="width: 100%; margin: 5px;"
                            onclick="viewreport();" id="btnSubmit"><i class="fa fa-thumbs-up"></i>GENARATE</a>
                
                   </div>
               
             <div class="col-md-2 col-sm-2 col-xs-4"  id="btnvisb3">
