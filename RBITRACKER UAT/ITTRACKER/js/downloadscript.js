$(window).on('load', function () {
    $("#tblFiles").empty();
             $.ajax({
                ...
                url: "FileDownloader.aspx/getTableData",
                data: "{pageVal:'GetAttachList', pageval1 :'', pageval2 :''}",
                dataType: "json",
                success: function (Result) {
                    ...
                    for (j = 0; j < valData.length - 1; j++) {
                        ...
                        var filename = "1967580" + contentDtl[1];
                        var extension = contentDtl[2];
                        var myUrl = "../Paperless/Images/" + filename;
                        
                        $('#tblFiles').append('<tbody><tr>' +
                            '<td>' + contentDtl[0] + '</td>' +
                            '<td><a href="' + myUrl + '" download="' + filename + '" class="file-list">' + contentDtl[1] + '</a></td>' +
                            '</tr> </tbody>');
    ...
    //    type: "post",
    //    contentType: "application/json; charset=utf-8",
    //    url: "FileDownloader.aspx/deleteDownloadFileAll",        
    //    data: "{input: '" + delFile + "' }",
    //    dataType: "json",
    //    success: function (Result) {
    //        $.ajax({
    ...
    //                    //var datas = new Blob([arr], {
    //                    //    type: mimetype
    //                    //});
    //                    //var dataURL = window.URL.createObjectURL(datas);
    //                    //debugger;
    //                    // var aItem1 = document.createElement("a");
    //                    //pItem1.appendChild(span1); 
    //                    //aItem1.setAttribute('href', dataURL);
    //                    //var aValue = document.createTextNode(filename);
    //                    //aItem1.appendChild(aValue); 

    //                    //var bytes = new Uint8Array(contentDtl[3]); // pass your byte response to this constructor

    //                    //var blobs = new Blob([contentDtl[3]], { type: mimetype });// change resultByte to bytes
    //                    //debugger;
    //                    //var link = document.createElement('a');
    //                    //link.href = window.URL.createObjectURL(blob);
    //                    //link.download = "myFileName.pdf";
    //                    //link.click();
    //                    //var dataURL1 = window.URL.createObjectURL(blobs);
    //                    $('#tblFiles').append('<tbody><tr>' +
    //                        '<td>' + contentDtl[0] + '</td>' +
    //                        '<td><a href="' + myUrl + '" download="' + filename + '" class="file-list">' + contentDtl[1] + '</a></td>' +
    //                        '</tr> </tbody>');
...
//    }, 10);
//}
function downloadFile(binaryString, filename, extension) {
...
//$('.fileinputclass').on('change', function () {
//        debugger;
//        readSingleFile();
//});
