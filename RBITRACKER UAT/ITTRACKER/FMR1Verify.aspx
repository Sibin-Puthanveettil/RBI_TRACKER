<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="FMR1Verify.aspx.cs" Inherits="RBIDATATRACK.FMR1Verify" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/style.min.css" rel="stylesheet" />                                                                                                                                         
    <script src="js/AutoCompleteJS.js"></script>                                                                                                                                                          
    <script src="js/FMR1Verify.js"></script>      
    ...
    <script type="text/javascript">
         function ShowHideDiv(chkPassport) {
             var dvPassport = document.getElementById("BorrowDirect");
             //alert(chkPassport.checked);
        dvPassport.style.display = chkPassport.checked ? "block" : "none";
        }

          function ShowHideDiv4(chkbrrinv) {
             var dvPassport = document.getElementById("borrowinv");
             //alert(chkPassport.checked);
        dvPassport.style.display = chkbrrinv.checked ? "block" : "none";
        }
         function ShowHideDiv5(chkbrracc) {
             var dvPassport = document.getElementById("brraccinv");
             //alert(chkPassport.checked);
        dvPassport.style.display = chkbrracc.checked ? "block" : "none";
        }
        function ShowHideDivv(chkPasspot) {
            var dvPassport = document.getElementById("Associate");
            
        dvPassport.style.display = chkPasspot.checked ? "block" : "none";
        }

        function ShowHideDivvv(chkPasspott) {
        var dvPassport = document.getElementById("DirectAssociate");
        dvPassport.style.display = chkPasspott.checked ? "block" : "none";
    }
				...
				<div id="FMR1">
                         ...
                         <br />
                             ...
                             <div  class="row col-md-12 p-1">
                                <label class="col-md-4" for="txtStartDt">Name of the NBFC :<span class="text-danger p-2">*</span></label>                          
                                    <input type="text" class="form-control" style="color:black; width:50%;" id="txt_HName" value="Manappuram Finance Limited" placeholder="Manappuram Finance Limited" readonly maxlength="30" required="required" />  
                             </div>
                             <div  class="row col-md-12 p-1" ID="FrNo">
                                <label class="col-md-4" for="txtStartDt">Fraud number :<span class="text-danger p-2">*</span></label>
                                   ...
                                   <input type="text" class="form-control" style="color:black; width:8%;" id="txt_f1" onkeypress="return onlyAlphabets(event,this);" onkeyup="this.value=this.value.toUpperCase()"  maxlength="4" required="required" />  
                                   <input type="text" class="form-control" style="color:black; width:30%;"  id="txt_f2"  maxlength="8" onkeypress="javascript:return isNumber(event)" required="required" />  
                               
                            </div>
                             <div id="BranchGold" style="display:none; ">
                                     <div class="row col-md-12 p-1">
                                           <br />
                                        <label  class=" col-md-4 ">Branch Type gold <span style="color:red">*</span></label>
                                    ...
                                    <div class="row col-md-12 p-1">
                                        ...
                                        <input type="text" class="form-control" style="color:black; width:30%;" id="txt_gplace" maxlength="30" required="required" />  
                                            <br />
                                      </div>   
                                   <div class="row col-md-12 p-1">

                                        <label  class=" col-md-4 ">District<span style="color:red">*</span></label>
                                        <input type="text" class="form-control" style="color:black; width:30%;" id="txt_district" readonly maxlength="30" required="required" />  
                                   </div>        
                                   <div class="row col-md-12 p-1">
      
                                        <label  class=" col-md-4 ">State<span style="color:red">*</span></label>
                                        <input type="text" class="form-control" style="color:black; width:30%;" id="txt_state" readonly maxlength="30" required="required" />  
                                 ...
                                 <div id="BranchVeh" style="display:none; ">
                                       <div class="row col-md-12 p-1">                                           <br />
                                        <label  class=" col-md-4 ">Branch Type vehicle <span style="color:red">*</span></label>
                                   ...
                                   <div class="row col-md-12 p-1">
                                        <label  class=" col-md-4 ">Name of the branch <span style="color:red">*</span></label>
                                        <input type="text" class="form-control" style="color:black; width:30%;" id="txt_BrVeh"   maxlength="30" required="required" />  
                                    ...
                                    <div class="row col-md-12 p-1">
                                           <br />
                                         <label  class=" col-md-4">Place<span style="color:red">*</span></label>
                                        <input type="text" class="form-control" style="color:black; width:30%;" id="txt_vehPlace"  maxlength="50" required="required" />  
                                            <br />
                                  </div>   
                                  <div class="row col-md-12 p-1">

                                        <label  class=" col-md-4 ">District<span style="color:red">*</span></label>
                                        <input type="text" class="form-control" style="color:black; width:30%;" id="txt_vehDist"   maxlength="50" required="required" />  
                                   </div>        
                                  <div class="row col-md-12 p-1">
      
                                        <label  class=" col-md-4 ">State<span style="color:red">*</span></label>
                                        <input type="text" class="form-control" style="color:black; width:30%;" id="txt_vehState"  maxlength="50" required="required" />  
                                 ...
                                 <div class="row col-md-12 p-1">
                                    ...
                                    <input type="text" class="form-control" style="color:black; width:30%;" id="txt_prinacc" placeholder="Principal party/account"  maxlength="500" required="required" />  
                                </div>
                                ...
                                <div class="row col-md-12 p-1">                                                                                                                                                                                       
                                   ...
                                   <input type="text" class="form-control amt" style="color:black; width:30%;" id="txt_getamt" placeholder="Calculated Amount" readonly maxlength="30" required="required" /> 
                                    ...
                                    <input type="text" class="form-control amt" style="color:black; width:30%;" id="txt_entamt" onkeypress="javascript:return isNumber(event)" placeholder="Amount"  maxlength="30" required="required" /> 
                                    <br /> <br /><br /> <br />                                                                                                                                                                                                                                                   
                                    <label  class="col-md-4 "><span style="color:red"></span></label>                                                                                                                                                                                   
                                    <label  class="col-md-4 "><span style="color:red"></span></label>                                                                                                                                                              
                                    ...
                                    <div class="modal__content">
                                        ...
                                        <div class="col-md-4 col-sm-2 col-xs-4">
                                            <a class="btn btn-sm animated-button thar-one btn-primary" style="width: 100%; margin: 5px;"
                                                onclick="getDetails();" id="btnSubmit" onload="true"><i ></i>Get Report</a>
                                        </div> 
                                        ...
                                        <a class="btn btn-sm animated-button thar-one btn-primary" style="width: 50%; margin: 5px;"
                                                onclick="calculateamt();" id="btnSubmit" onload="true"><i ></i>Calculate Amount</a>
                                         <div class="row col-md-12 p-1">
                                            <label  class=" col-md-4 ">Calculated Amount <span style="color:red">*</span></label>
                                            <input type="text"  class="form-control" style="width:30%;"  placeholder="Total amount Calculated" id="CalAmt"  />&nbsp;&nbsp;&nbsp;
                                         </div>  
                    ...
                    <div id="FMR1B">
                        ...
                        <div class="row col-md-12 p-1">                           
                                ...
                                <input type="text" class="form-control" style="color:black; width:30%;" id="tx_delay"  required="required" />  
                         ...
                         <div class="row col-md-12 p-1" >                                                                                                                                                                                                                                                     
                                ...
                                <textarea class="form-control" id="txt_history"  rows="2" cols="33"   onchange="checklimit('history')" minlength="500"></textarea>
                         </div>                                                                                                                                                                                                                                                     
                         <div class="row col-md-12 p-1" >                                                                                                                                                                                                                                                     
                                <label  class=" col-md-10 ">Modus operandi<span style="color:red">*</span></label>                                                                                                                                                                       
                                <label  class=" col-md-10" id="Modus" style="display:none;"><span style="color:red">Minimum 500 character required</span></label>
                                <textarea class="form-control" id="txt_Modus"  rows="2" cols="33"   minlength="50"></textarea>
                         </div>
                        <div class="row col-md-12 p-1">                                                                                                                                                                                                                                                     
                    ...
                    <div id="comp" style=" display:none;"> 
                        <div class="row col-md-12 p-1">                                                                                                                                   
                               ...
                               <input type="text" class="form-control" style="color:black; width:30%;" id="txt_comp" placeholder=""  required="required" />  
                        </div>
                                    ...
                                    <div   class="row col-md-12 p-1" >  
                                      ...
                                      <table style="left:40px;">
                                          ...
                                          <tr>
                                              ...
                                              <td class=" col-md-1 align-right"><input type="text" id ="emp_name" readonly="true" class="form-control"  style="width: 70px; color:maroon" required /></td>
                                              <td class=" col-md-1 align-right"><input type="text" id ="emp_des" readonly="true" class="form-control"  style="width: 70px; color:maroon" required /></td>
                    ...
                    <br />   <br />
			         <div class="row col-md-12 p-1">                           
                        ...
                        <div class="row col-md-12 p-1">      
                                ...
                                <input type="text" class="form-control" style="color:black; width:30%;" id="txt_Delayrs"  maxlength="500" required="required" />  
                         </div> 
                          <div class="row col-md-12 p-1">      
...
<%--           --------------------------------------------END OF AUDIT TAB---------------------------------------------------------%>
                        ...
                        <br />   <br />
                         <div class="row col-md-12 p-1"> 
                           <label class="col-md-12" ><p style="font-size:15px;">Total amount recovered</p></label>
                                ...
                                <input type="text" class="form-control txt_cal" style="color:black; width:30%;" id="txt_riimtotamt" onkeypress="javascript:return isNumber(event)"  maxlength="30" required="required" /> 
                        </div>
                          <div class="row col-md-12 p-1">      
                                <label  class=" col-md-4 "> From insurance(B)<span style="color:red">*</span></label>
                                <input type="text" class="form-control txt_cal" style="color:black; width:30%;" id="txt_ins" onkeypress="javascript:return isNumber(event)"  maxlength="30" required="required" /> 
                         </div> 
                         <div class="row col-md-12 p-1">      
                                <label  class=" col-md-4">From other sources(C)<span style="color:red">*</span></label>
                                 <input type="text" class="form-control txt_cal"  style="color:black; width:30%;" id="txt_othsrc" onkeypress="javascript:return isNumber(event)"  maxlength="30" required="required" /> 
                         </div> 
                        <div class="row col-md-12 p-1">      
                                <label  class=" col-md-4">Extent of loss to the NBFC(TotalAmount-(A+B+C))<span style="color:red">*</span></label>
                                 <input type="text" class="form-control total" readonly  style="color:black; width:30%;" id="txt_losstot"  maxlength="30" required="required" /> 
                         </div> 
                  ...
                  <div id="COMP">        
                    <br />   <br />
                      ...
                      <br />
                       ...
                       <p style=" font-weight:bold">If any Borrowal account Involved??
                           <input type="checkbox" id="chkbrrinv" onclick="ShowHideDiv4(this)" /></p>
                      
                            <div id="borrowinv" style="display:none;">
                                    <div   class="row col-md-12 p-1" >  

                                      <table style="left:40px;">
                                          <th class=" col-md-1 align-right">Sr. No</th>
                                          <th class=" col-md-1 align-right">Type of party</th>
                                          <th class=" col-md-1 align-right">Name of party/account</th>
                                          <th class=" col-md-1 align-right">Party Address</th>
                                          
                                          <tr>
                                              <td class=" col-md-1 align-center"><input type="text" id ="brrsrno" class="form-control"    style="width: 150px; color:maroon"  required /></td>
                                              <td class=" col-md-1 align-center"><input type="text" id ="brrprty"  class="form-control"  style="width: 150px; color:maroon" required /></td>
                                              <td class=" col-md-1 align-center"><input type="text" id ="brrpracc" class="form-control"  style="width: 150px; color:maroon" required /></td>
                                              <td class=" col-md-1 align-center"><input type="text" id ="brraddr" class="form-control"  style="width: 150px; color:maroon" required /></td>
                                             
                                         </tr>                                          
                                      </table> 
                                          <a href="#" class="btn btn-sm animated-button thar-one btn-primary" style="width: 100%;margin: 5px;"onclick="return ADDbrrdtl();" id="btnAddbrr">Add</a>
                                     <div class="form-group col-md-12 padding-bottom-10px" style="color: black;">                   
                                        <div style="overflow:scroll">
                                            <table class="table1 table-hover" id="tblbrr" style="width:50%">
                                            </table>
                                        </div>
                                    </div>
                        ...
                        <p style=" font-weight:bold">Borrowal Accounts Details
                           <input type="checkbox" id="chkbrracc" onclick="ShowHideDiv5(this)" /></p>
                      
                            <div id="brraccinv" style="display:none;">
                                    <div   class="row col-md-12 p-1" >  

                                      <table style="left:40px;">
                                          <th class=" col-md-1 align-right">Party Sr.No</th>
                                          <th class=" col-md-1 align-right">Name of party/Acount</th>
                                          <th class=" col-md-1 align-right">Borrowal account Sr no</th>
                                          <th class=" col-md-1 align-right">Nature of Account</th>
                                          <th class=" col-md-1 align-right">Date of Sanction</th>
                                          <th class=" col-md-1 align-right">Sanction Limit</th>
                                          <th class=" col-md-1 align-right">Balance Outstanding</th>
                                          <tr>
                                              <td class=" col-md-1 align-center"><input type="text" id ="prtysrno" class="form-control"    style="width: 100px; color:maroon"  required /></td>
                                              <td class=" col-md-1 align-center"><input type="text" id ="prtyname"  class="form-control"  style="width: 100px; color:maroon" required /></td>
                                              <td class=" col-md-1 align-center"><input type="text" id ="prtybrsno" class="form-control"  style="width: 100px; color:maroon" required /></td>
                                              <td class=" col-md-1 align-center"><input type="text" id ="prtyntracc" class="form-control"  style="width: 100px; color:maroon" required /></td>
                                               <td class=" col-md-1 align-center"><input type="text" id ="datesnton"  class="form-control"  style="width: 100px; color:maroon" required /></td>
                                              <td class=" col-md-1 align-center"><input type="text" id ="sanlim" class="form-control"  style="width: 100px; color:maroon" required /></td>
                                              <td class=" col-md-1 align-center"><input type="text" id ="balouts" class="form-control"  style="width: 100px; color:maroon" required /></td>
                                         </tr>                                          
                                      </table> 
                                          <a href="#" class="btn btn-sm animated-button thar-one btn-primary" style="width: 100%;margin: 5px;"onclick="return ADDbrraccdtl();" id="btnbrracc">Add</a>
                                     <div class="form-group col-md-12 padding-bottom-10px" style="color: black;">                   
                                        <div style="overflow:scroll">
                                            <table class="table1 table-hover" id="tblbrracc" style="width:50%">
                                            </table>
                                        </div>
                                    </div>
                       ...
                       <p style=" font-weight:bold">If any Borrowal account Director/proprietor Involved??
                           <input type="checkbox" id="chkPassport" onclick="ShowHideDiv(this)" /></p>
                      <div id="BorrowDirect"  style="display:none">
                          <br />
                          <br />
                         
                      <%--     <input type="checkbox" name="boracc" id="boraccy" value="yes" onchange="borrowy();" onclick="borrowy();">Yes --%>                           
                           <%--<input type="radio" name="boracc" id="boraccn" value="no" onclick="borrown();">No--%>

                           <label class="col-md-12" ><p style="font-size:15px;">Borrowal account Director/proprietor details</p></label>
                                    <div   class="row col-md-12 p-1" id="Borrowal"> 
                                      <table style="left:40px;">
                                          <th class=" col-md-1 align-right">Sr. No.</th>
                                          <th class=" col-md-1 align-right">Name of party/account</th>
                                          ...
                                          <th class=" col-md-2 align-right">Address</th>
                                            <tr>
                                              <td class=" col-md-1 align-right"><input type="text" id ="SrNo" class="form-control"  style="width: 100%; color:maroon" onkeypress="javascript:return isNumber(event)" required /></td>
                                            ...
                                            <tr>
                                              <td class=" col-md-1 align-right"><input type="text" id ="SrNo1" class="form-control"  style="width: 100%; color:maroon" onkeypress="javascript:return isNumber(event)" required /></td>
                       ...
                       <p style=" font-weight:bold">If any Associate Concerns Involved??
                           <input type="checkbox" id="chkPasspot" onclick="ShowHideDivv(this)" /></p>

                       <div id="Associate" style="display:none">
                          <br />
                          <br />
                                      ...
                                      <table style="left:40px;">
                                          ...
                                          <th class=" col-md-2 align-right">Address</th>
                                            <tr>
                                              ...
                                              <td class=" col-md-1 align-right"><input type="text" id ="SrNoAssoc" class="form-control"  style="width: 100%; color:maroon" onkeypress="javascript:return isNumber(event)" required /></td>
                                              ...
                                              <td class=" col-md-1 align-right"><input type="text" id ="SrNoAssoc1" class="form-control"  style="width: 100%; color:maroon" onkeypress="javascript:return isNumber(event)" required /></td>
                      ...
                      <p style=" font-weight:bold">If any Associate Concern Director/proprietor Involved??
                           <input type="checkbox" id="chkPasspott" onclick="ShowHideDivvv(this)" /></p>
                      <div id="DirectAssociate"  style="display:none">
                          <br />
                          <br />
                                      ...
                                      <table style="left:40px;">
                                          ...
                                          <th class=" col-md-2 align-right">Address</th>
                                            <tr>
                                              ...
                                              <td class=" col-md-1 align-right"><input type="text" id ="SrNoAs" class="form-control"  style="width: 100%; color:maroon" onkeypress="javascript:return isNumber(event)" required /></td>
                                            ...
                                            <tr>
                                              ...
                                              <td class=" col-md-1 align-right"><input type="text" id ="SrNoAs1" class="form-control"  style="width: 100%; color:maroon" onkeypress="javascript:return isNumber(event)" required /></td>
           ...
           <div >
            ...
            <div class="col-md-2">
                ...
                <div class="col-md-6">
                  <a href="#" class="btn btn-sm animated-button thar-one btn-primary" style="width: 100%; margin: 5px;"
                                onclick="FRConfirmModify();" id="btnSubmitt"><i class="fa fa-thumbs-up" ></i>Confirmation of modification</a>
    ...
    <input id="hdbrrdata" type="hidden" runat="server" />
    <input id="hdbrraccdata" type="hidden" runat="server" />
