<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="Incident_Remove.aspx.cs" Inherits="RBIDATATRACK.Incident_Remove" %>
...
<%--   <script src="js/IncidentEntry.js" + "new Date().getTime()"></script>--%>
    <script src="js/IncidentRemove.js"+ "new Date().getTime()"></script>
       ...
       <div class="card-body">
           <div class="container">
                        <div class="row ">
                            <div class="ma-header">
                                <div class="col-md-12">
                                    <h3 class="text-center"; style="color: #010024;"><i class=""></i>INCIDENT REMOVE</h3>
                                </div>
                            </div>
                        </div>
           </div>
            ...
            <div class="row" id="row1">
             <div class="col-md-5">
               <div class="form-group">
                 <label for="ddlbranch">Incident : <span class="text-danger">*</span></label>
                  <div class="div-select-dark">
                       <select class="form-control select2" id="ddlincident" style="width: 100%" name="incident" onchange="get_fraud_dtls();">
          ...
          <div class="col-md-5">
               <div class="form-group">
                 <label for="ddlname">Fraud Type <span class="text-danger">*</span></label>
                  <label class="pure-material-textfield-outlined">
                <input type="text" placeholder=" " id="frd_type" title="Fraud_amt" maxlength="199"  readonly="true" />
        ...
        <div class="col-md-5">
               <div class="form-group">
                 <label for="ddlname">Zone<span class="text-danger">*</span></label>
                  <label class="pure-material-textfield-outlined">
                <input type="text" placeholder=" " id="zone" title="Fraud_amt" maxlength="199" readonly="true" />
                 <span>Zone Name</span>
                </label>
               </div>
             </div>
            ...
            <div class="col-md-5">
               ...
               <div class="row" id="row6">
                                       <div class="col-md-10">
                 <label for="ddlatt2">Reason<span class="text-danger">*</span></label>
                        <label class="pure-material-textfield-outlined">
                            ...
                            <span>Enter Reason For Remove</span>
                        </label>
