<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="IncidentEntry.aspx.cs" Inherits="RBIDATATRACK.IncidentEntry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="StyleAutoComplete.css" rel="stylesheet" />
<script src="AutoCompleteJS.js"></script>
    <script src="js/IncidentEntry.js" + "new Date().getTime()"></script>
       ...
       <div class="card-body">
           <div class="container">
                        <div class="row ">
                            <div class="ma-header">
                                <div class="col-md-12">
                                    <h3 class="text-center"; style="color: #010024;"><i class=""></i>INCIDENT ENTRY</h3>
                                </div>
                            </div>
                        </div>
           </div>
           <div class="container">
            ...
            <div class="row" id="row1">
               ...
               <div class="form-group">
                 <label for="ddlbranch">Branch : <span class="text-danger">*</span></label>
                  <div class="div-select-dark">
                       <select class="form-control select2" id="ddlbranch" style="width: 100%" name="Branch" onchange="">
             ...
             <div class="col-md-5">
              <div class="form-group">
                 <label for="ddlType">Fraud Type  </label>
                   <div class="div-select-dark">
                     <select class="select-light" id="ddlType" style="width: 100%" name="Develpor" onchange="load_popup()">
          ...
          <%--</div>--%>
           ...
           <div class="row" id="row2">
             <div class="col-md-5">
              <div class="form-group">
                 <label for="ddlcategory">Zone name </label>
                   <div class="div-select-dark">
             ...
             <div class="col-md-5">
               <div class="form-group">
                ...
                <input type="text" placeholder=" " id="txtamt" title="Fraud_amt" maxlength="199" onkeypress="return isNumberKey(event)" oninput="this.value = this.value.replace(0-9);" />
             ...
             <div class="col-md-5">
               <div class="form-group">
                 <label for="ddlname">Irregularity <span class="text-danger"></span></label>
                  <label class="pure-material-textfield-outlined">
                <input type="text" placeholder=" "id="txtirreglar" title="irreglarity" maxlength="199" oninput="this.value = this.value.replace(/[^ a-zA-Z0-9&.,_-“”‘’'%]/g, '');" />
            ...
            <div class="col-md-5">
               <div class="form-group">
                 <label for="ddldate">Date Of Reporting <span class="text-danger">*</span></label>
                  <label class="pure-material-textfield-outlined">
                <input type="text" placeholder=" "id="ddldate" title="TarDt" readonly= "true" />
...
<%--            <div class="col-md-5">
             <div class="form-group">
               <label for="ddlcategory">Fraud Category : <span class="text-danger">*</span></label>
                 <div class="div-select-dark">
                  <select class="select-light" id="ddlcategory" style="width: 100%" name="Develpor" onchange="GetAssignedWork()">
                ...
                <div class="col-md-5">
               <div class="form-group">
                    <label>Select Mail Users: <span class="text-danger">*</span></label>
               ...
               <div class="row" id="row6">
                 ...
                 <label for="ddlatt2">Fraud Details<span class="text-danger">*</span></label>
                        <label class="pure-material-textfield-outlined">
                            ...
                            <textarea rows="1" cols="13" name="txtdesc" id="txtdescription" title="description" oninput="this.value = this.value.replace(/[^-@.,/#&+\w\s]/g, '';"></textarea>
